// Automated review generation scheduler
import { pool } from './db.js';
import { generateReviewContent, shuffleArray } from './simple-reviews.js';
...
async function addRandomReview(product) {
  try {
    ...
    const { title, content, pros, cons } = generateReviewContentInternal(
      product.name, 
...
/**
 * Helper function to generate review content - internal function 
 * Used by review-scheduler only
 */
function generateReviewContentInternal(productName, category, rating) {
